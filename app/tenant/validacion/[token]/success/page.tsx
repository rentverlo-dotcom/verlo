  ...
  Contacto
      ...
      <section className="success-hero">
        <div className="container success-card">
          ...
          <p className="eyebrow">Validación recibida</p>

          <h1>Listo. Ya tenemos tu perfil para avanzar.</h1>

          <p>
            Verlo va a revisar tu documentación, tus ingresos y tu respaldo para
            presentarte mejor ante propietarios compatibles.
          </p>

          <div className="success-grid">
            <article>
              <strong>1</strong>
              <span>Identidad recibida</span>
            </article>

            <article>
              <strong>2</strong>
              <span>Ingresos y garantía cargados</span>
            </article>
