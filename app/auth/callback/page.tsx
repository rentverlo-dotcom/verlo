      ...
      async function finishLogin() {
        try {
          ...
          if (
            ...
            setMessage(
              "Tu acceso está confirmado. Estamos preparando Mi Verlo."
            )

            const response =
              await fetch(
                "/api/auth/complete-lead-profile",
                {
                  method:
                    "POST",
          ...
          // =====================================================
          // 2. FLUJO EXISTENTE POST-CONTRATO
          // NO LO ROMPEMOS
          // =====================================================
